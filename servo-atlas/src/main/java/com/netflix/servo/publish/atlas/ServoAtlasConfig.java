...
public interface ServoAtlasConfig {
  ...
  /**
   * The maximum size of the batch of metrics to be sent to atlas. If attempting to send more metrics
   * than this value, the {@link AtlasMetricObserver} will split them into batches before sending
